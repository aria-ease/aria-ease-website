    ...
    <div className="header">
        ...
        <div className='header-buttons-grid-div' id="header-buttons-grid-div">
            ...
            {/* <button className='header-button center-flex' onClick={() => {setDarkMode(!darkMode)}}>
                {darkMode ? 
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="Sun" height="18" width="18">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" id="Moon" height="18" width="18">
