...
const Header = ({darkMode, setDarkMode, showDropdownPage, setShowDropdownPage}) => {
  ...
  return (
    <div className="header">
        <button className='header-menu-button block-interactive center-flex' onClick={() => setShowDropdownPage(!showDropdownPage)}>
        ...
        <div className='header-nav-link-div' id="header-nav-link-div">
            <Link to='/docs' className='header-nav-link block-interactive'>Documentation</Link>
            <Link to='/examples/menu' className='header-nav-link block-interactive'>Examples</Link>
            <Link to='https://github.com/Scriptkidd98/aria-ease' className='header-nav-link block-interactive'>Github</Link>
        </div>
        ...
        <div className='header-buttons-grid-div' id="header-buttons-grid-div">
            <a href="https://github.com/Scriptkidd98/aria-ease" className='header-button block-interactive center-flex'><FaGithub className='header-button-icon'/></a>
