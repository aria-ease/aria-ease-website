  ...
  return (
    <div className="header">
        ...
        <div className='header-buttons-grid-div' id="header-buttons-grid-div">
            ...
            <button className='header-button center-flex' onClick={() => {setDarkMode(!darkMode)}}>{darkMode ? <FaSun className='header-button-icon'/> : <FaMoon className='header-button-icon'/>}</button>
        </div>
    </div>
  )
}
