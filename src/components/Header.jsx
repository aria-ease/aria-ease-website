  ...
  return (
    <div className="header">
        ...
        <div className='header-buttons-grid-div' id="header-buttons-grid-div">
            ...
            <button className='header-button block-interactive center-flex' onClick={() => {setDarkMode(!darkMode)}} onKeyDown={(event) => {if(event.key === 'Enter' || event.key === " ") {event.preventDefault(); setDarkMode(!darkMode)}}}>
