              ...
              <Col xs={12} sm={12} md={12} lg={9}>
                <div className='side-body-div'>
                  ...
                  <div className='mt-10'>
                    ...
                    <h3 className='mt-4'>aria-expanded</h3>
                    ...
                    <h3 className='mt-4'>aria-controls</h3>
                    ...
                    <h3 className='mt-4'>aria-labelledby</h3>
                  ...
                  <div className='flex justify-between items-center mt-[100px]'>
                    <a href='/docs' className='block-interactive next-link rounded-lg'>
                      <div className='flex flex-col px-4 py-3'>
                        <span className='text-sm black-white-text'>Prev</span>
                        <span className='text-blue-500 text-lg'>Getting Started</span>
                      </div>
                    </a>
