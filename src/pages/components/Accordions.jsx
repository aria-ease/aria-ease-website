  ...
  return (
    ...
    <div id="inner-body-div">
      <Helmet>
        ...
        <meta name="keywords" content="Accordion component, accessible accordion, ARIA attributes, expand/collapse sections, keyboard interaction, React accordion example" />
        <meta name="og:title" content="Accordion | Aria-Ease" />
        <meta name="og:description" content="Learn how to use the Accordion component for accessible expandable and collapsible content sections. Includes ARIA attributes and usage examples." />
        <meta name="og:url" content="https://ariaease.site/components/accordion" />
        <meta name="twitter:title" content="Accordion | Aria-Ease" />
        <meta name="twitter:description" content="Learn how to use the Accordion component for accessible expandable and collapsible content sections. Includes ARIA attributes and usage examples." />
      ...
      page={page}
        ...
        <div className='side-body-div docs-flow'>
                  ...
                  <ul className='list-disc ml-6 mt-2'>
                    ...
                    <li><code>callback</code> (object, optional): An object with callback functions for accordion interaction changes</li>
                  </ul>
                  </section>
                  ...
                  <section>
                      ...
                      <Terminal darkMode={darkMode} title="Accordion.jsx" lang="jsx">{basicSetup}</Terminal>

                      <p className='mb-2 mt-6'>Minimal HTML structure (no ARIA attributes needed):</p>
                      <Terminal darkMode={darkMode} title="Minimal HTML Structure" lang="jsx">{accordionHTML}</Terminal>
                  ...
                  <div className='flex flex-wrap gap-2 py-4 max-w-7xl md:py-12 mt-[100px] justify-between'>
                    <Link to='/components/overview' className='block-interactive next-link docs-next-link rounded-lg md:min-w-80 md:max-w-md w-full md:w-auto flex gap-6 items-center px-4 py-6 md:px-5'>  
                      ...
                      <div className='flex flex-col w-full'>
                        ...
                        <span className='next-link-text text-md'>Component Overview</span>
                      </div>
                    </Link>
