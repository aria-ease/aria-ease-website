...
const withCallbacks = `
Combobox.makeComboboxAccessible({
  comboboxInputId: "search-input",
  listBoxId: "suggestions-list",
  listBoxItemsClass: "suggestion-item",
  callback: {
  ...
  return (
    <div id="inner-body-div">
      <Helmet>
            ...
            <meta name="keywords" content="combobox utility, accessible comboboxes, ARIA attributes, keyboard interaction, focus management, React combobox example" />
            <meta name="og:title" content="Combobox | Aria-Ease" />
            <meta name="og:description" content="Explore how to use the Aria-Ease combobox utility for building accessible comboboxes with complete keyboard interaction, focus management, and ARIA attributes." />
            <meta name="og:url" content="https://ariaease.site/components/combobox" />
            <meta name="twitter:title" content="Combobox | Aria-Ease" />
            <meta name="twitter:description" content="Explore how to use the Aria-Ease combobox utility for building accessible comboboxes with complete keyboard interaction, focus management, and ARIA attributes." />
      ...
      page={page}
        ...
        <div className='side-body-div docs-flow'>
                  <div className='side-body-sections-div tone-card tone-card-emphasis docs-hero-card'>
                    ...
                    <h1 className='introduction-heading black-white-text'>Combobox <span className='text-gradient'>Component</span></h1>
                  ...
                  <section>
                    <p className='mb-2'>Import the utility:</p>
                      <CodeBlockDemo code={"import * as Combobox from aria-ease/combobox"}/>

                      <p className='mb-2 mt-6'>Basic setup:</p>
                      <Terminal darkMode={darkMode} title="Basic Combobox Setup Example" lang="js">{basicSetup}</Terminal>

                      <p className='mb-2 mt-6'>Filtering Logic:</p>
                      <Terminal darkMode={darkMode} title="Filtering Logic Example" lang="js">{filteringLogicExample}</Terminal>

                      <p className='mb-2 mt-6'>Add event callbacks to respond to user actions:</p>
                      <Terminal darkMode={darkMode} title="Combobox with Callbacks Example" lang="js">{withCallbacks}</Terminal>

                      <p className='mb-2 mt-6'>Minimal HTML structure (no ARIA attributes needed):</p>
                      <Terminal darkMode={darkMode} title="Combobox Component Markup Example" lang="html">{comboboxComponent}</Terminal>
                  ...
                  <section>
                    ...
                    <ul className='list-disc ml-6 mt-2'>
                      ...
                      <li><code>Tab</code>: Selects currently focused option, closes listbox and moves to next focusable element</li>
                    </ul>
                  </section>
