                ...
                <div className='side-body-div'>
                  ...
                  <div className='side-body-sections-div'>
                    ...
                    <>
                      ...
                      <p>A block can be headers, tabs, entire web pages (requires more diligence in DOM tree structuring), interactive sliders and carousels e.t.c. Basically any component that is permanently displayed, unlike a menu that toggles display, and has a list of interractive children items.</p>
                      <HomeTabExampleOne/> 
