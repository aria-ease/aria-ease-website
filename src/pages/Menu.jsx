...
const withCallback = `menuRef.current = Menu.makeMenuAccessible({
  menuId: "custom-menu",
  menuItemsClass: "profile-menu-item",
  triggerId: "display-button",
  callback: {
            ...
            <Row>
              ...
              <Col xs={12} sm={12} md={12} lg={9} className='px-0'>
                <div className='side-body-div'>
                  ...
                  <h3 className='mt-10 break-words'>makeMenuAccessible()</h3>
...
<div id="submenu-id" style={{display: "none"}}>
  ...
  <button className="menu-item">Submenu Item 2</button>
                  ...
                  <div className='example-each-ui-code-block-div mt-10'>
                    <h3 className='mb-1'>Basic Menu Example</h3>
                    <p>Notice the clean HTML - no ARIA attributes needed on menu items or container. Just IDs and class names:</p>
                  ...
                  <div className='mt-10'>
                    ...
                    <p className='mt-2'>If you need to dynamically add or remove menu items after initialization, use the <code>refresh()</code> method:</p>
